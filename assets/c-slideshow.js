import EmblaCarousel from "//www.arttakestime.com/cdn/shop/t/8/assets/m-carousel.js?v=7956072137199587391732788640"
import ClassNames from "//www.arttakestime.com/cdn/shop/t/8/assets/h-carousel-cn.js?v=74413230910519084281732788640"
    ...
    customElements.define('coretex-slideshow', class CoretexSlideshow extends HTMLElement {
        ...
        async connectedCallback() {
            ...
            if (this.hasAttribute('autoplay')) {
                ...
                const { default: Autoplay } = await import("//www.arttakestime.com/cdn/shop/t/8/assets/h-carousel-ap.js?v=151989844542395062071732788640"); // conditionally load plugin w/ dynamic imports
            ...
            if (this.hasAttribute('fade')) {
                const { default: Fade } = await import("//www.arttakestime.com/cdn/shop/t/8/assets/h-carousel-fa.js?v=36576538050214963121732788640"); // conditionally load plugin w/ dynamic imports
                plugins.push(Fade());
            }
